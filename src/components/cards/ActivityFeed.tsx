...
function getActivityStyle(item: Activity) {
  switch (item.type) {
    ...
    case 'SOLUTION_UPVOTED': return { highlight: `${item.actorName} upvoted your solution:`, dot: 'bg-amber-400', ring: 'border-amber-500 bg-amber-500/20', text: 'text-amber-400' }
